...
rate = rospy.Rate(10)
rospy.sleep(0.5)
record_odom_client = actionlib.SimpleActionClient('/rec_pose_as',RecordOdomAction)
...
service_object = rospy.ServiceProxy('/my_service', Motion_Service)
...
record_odom_client.send_goal(RecordOdomGoal,feedback_cb=rec_odom_feedback_callback)
rospy.loginfo("Goal message sent")
request = Motion_ServiceRequest()
